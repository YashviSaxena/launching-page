...
const Home = () => {
  return (
    <div className="h-screen w-screen bg-[#03022A] px-48">
       <img src={straight} alt=""  className="absolute left-8 md:left-16 h-[500px] mt-10"/>
       <img src={vector7575} alt="" className='absolute lg:block hidden top-32 w-[700px] ml-16    -z-1' />
      ...
      <Phone/>
      <img src={straight} alt=""  className="absolute md:right-24 right-12 h-[500px] mt-10"/>
